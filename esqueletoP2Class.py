...
class EsqueletoP2:
    def __init__(self):
        ...
        esqueleto_path = os.path.join(assets_path, "Esqueleto")
        #definindo as animaçoes e quantos frames cada tem
        self.png = Sprite(os.path.join(esqueleto_path, "esqueleto.png"))
        self.idle_anim = Sprite(os.path.join(esqueleto_path, "Idle.png"), 7)
        self.attack1_anim = Sprite(os.path.join(esqueleto_path, "Attack_1.png"), 5)
        self.attack2_anim = Sprite(os.path.join(esqueleto_path, "Attack_2.png"), 6)
        self.attack3_anim = Sprite(os.path.join(esqueleto_path, "Attack_3.png"), 4)
        self.dead_anim = Sprite(os.path.join(esqueleto_path, "Dead.png"), 4)
