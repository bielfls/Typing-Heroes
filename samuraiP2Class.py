...
class SamuraiP2:
    def __init__(self):
        ...
        self.idle_anim = Sprite(os.path.join(samurai_path, "Idle.png"), 6)
        self.attack1_anim = Sprite(os.path.join(samurai_path, "Attack_1.png"), 4)
        self.attack2_anim = Sprite(os.path.join(samurai_path, "Attack_2.png"), 5)
        self.attack3_anim = Sprite(os.path.join(samurai_path, "Attack_3.png"), 4)
        self.dead_anim = Sprite(os.path.join(samurai_path, "Dead.png"), 6)
